...
import {
  ...
  Users, Leaf, BarChart3, Shield, ChevronRight, CheckCircle2, User, LogIn, Sparkles
} from 'lucide-react';
      ...
      <div className="login-card-container">
        ...
        <div className="login-left">
          <div className="login-left-content">
            ...
            <div className="login-badge">
              <Sparkles size={14} className="pulse-icon" /> AI-Powered Farming Assistant
            </div>
        ...
        <div className="login-right">
          <div className="login-form-wrap">
            ...
            <form onSubmit={handleSubmit} style={{ width: '100%' }}>
              <div className="login-form-group">
                ...
                <div className="login-input-wrap">
                  <Mail size={18} className="search-ico" />
                  <input
                    id="admin-email"
                    type="email"
              ...
              <div className="login-form-group">
                ...
                <div className="login-input-wrap">
                  <Lock size={18} className="search-ico" />
                  <input
                    id="admin-password"
            ...
            >
              <div className="login-creds-title">⚡ Quick Auto-fill Admin Credentials</div>
              <div className="login-creds-row">
                <div className="login-cred-pill">
                  <User size={13} /> admin@krushisathi.com
                </div>
                <div className="login-cred-pill">
                  <Lock size={13} /> Admin@2024
                </div>
              </div>
            </div>
          </div>
